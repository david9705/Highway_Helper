...
Reg_addr = 'team3final' #if None, Reg_addr = MAC address

DAN.profile['dm_name']='highwayN'
DAN.profile['df_list']=['highwayN']
    ...
    try:
        ...
        for i in range(0,a):
            ...
            for j in range(0,b):
                ...
                DAN.push ('highwayN', lat, log,"國五N_kmp"+str(kmp),realtimespeed, datetime.now().strftime('%Y-%m-%d %H:%M:%S'))
                time.sleep(0.1)
        print("-------------------------------------------------")
