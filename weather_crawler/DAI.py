...
while True:
    try:
        ...
        #w_L= str(random.randint(30,60))
        w_P=parse_weather_Pinglin.parse_weather()   
        w_Sh=parse_weather_Shiding.parse_weather()  
        #w_Sh= str(random.randint(30,60))
        w_Su=parse_weather_Suao.parse_weather()
        #w_Su= str(random.randint(30,60))
