...
ServerURL = '140.113.199.188' #with no secure connection
#ServerURL = 'https://DomainName' #with SSL connection
Reg_addr = 'highwayS' #if None, Reg_addr = MAC address

DAN.profile['dm_name']='highwayS'
DAN.profile['df_list']=['highwayS']
    ...
    #Push data to a device feature called "Dummy_Sensor"
        ...
        for i in range(0,a):
            ...
            for j in range(0,b):
                ...
                DAN.push ('highwayS', lat, log,"國五S_kmp"+str(kmp),realtimespeed, datetime.now().strftime('%Y-%m-%d %H:%M:%S'))
                time.sleep(0.1)
        print("------------------------------------------------")
        first_forty_d.clear()
